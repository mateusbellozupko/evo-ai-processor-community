# AutomaLead Agent Processor — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "AutomaLead Agent Processor" are trademarks of
AutomaLead The "evocrm-processor" wordmark and the AutomaLead Agent Processor
logo are trademarks of AutomaLead

## 1. Scope and purpose

This policy governs the use of AutomaLead Agent Processor trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
AutomaLead Agent Processor visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "AutomaLead Agent Processor";
...
(d) any materials that implement or express the AutomaLead Agent Processor official look
...
2.1. You may truthfully refer to AutomaLead Agent Processor to describe that your software
...
AutomaLead Agent Processor that include AutomaLead Agent Processor brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use AutomaLead Agent Processor marks in nominative ways, such as
"based on AutomaLead Agent Processor", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "AutomaLead Agent Processor";
...
AutomaLead Agent Processor brand assets.** If you distribute or publicly host any version
of the user interface that uses AutomaLead Agent Processor brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove AutomaLead Agent Processor brand assets.**
...
(a) remove and replace all AutomaLead Agent Processor trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from AutomaLead Agent Processor.

4.3. **No endorsement.**
You may not use AutomaLead Agent Processor trademarks or brand assets in a way that
...
AutomaLead Agent Processor logo or wordmark.
...
Any violation of this policy terminates your permission to use AutomaLead Agent Processor
brand assets. You must promptly cease use and remove AutomaLead Agent Processor trademarks
